            ...
            <div class="mb-6 rounded-xl border border-amber-200 dark:border-amber-900/60 bg-amber-50/60 dark:bg-amber-950/20 overflow-hidden">
                ...
                <div class="p-3 space-y-2">
                    <div class="flex items-center space-x-2">
                        ...
                        <div contenteditable="true" id="pin-slot-0" oninput="window.updatePinSlot(0, this)" class="pin-slot flex-1 text-sm text-stone-800 dark:text-stone-100 bg-white dark:bg-stone-900 border border-amber-200 dark:border-amber-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-400 min-h-[36px] leading-relaxed empty:before:content-[attr(data-placeholder)] empty:before:text-stone-300 dark:empty:before:text-stone-600 empty:before:pointer-events-none" data-placeholder="Pin a note or @mention a session...">${escapeHtml(pin0text)}</div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <i data-lucide="pin" class="w-3.5 h-3.5 text-amber-400 dark:text-amber-500 flex-shrink-0"></i>
                        <div contenteditable="true" id="pin-slot-1" oninput="window.updatePinSlot(1, this)" class="pin-slot flex-1 text-sm text-stone-800 dark:text-stone-100 bg-white dark:bg-stone-900 border border-amber-200 dark:border-amber-800 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-amber-400 min-h-[36px] leading-relaxed empty:before:content-[attr(data-placeholder)] empty:before:text-stone-300 dark:empty:before:text-stone-600 empty:before:pointer-events-none" data-placeholder="Pin a note or @mention a session...">${escapeHtml(pin1text)}</div>
                    </div>
                </div>
            </div>`;
